...
# Перезапись final_data_wide с удалением колонок с процентом NA/0 более threshold_percent 
final_data_wide <- final_data_wide %>% 
  select (row.names(filtered_columns))
...
-   Используя метод пермутаций провери отличаются ли группы в зависимомти от Health_state
